...
function RelatedProducts(props) {
  ...
  async function viewRelatedProduct() {
    fetch(UNIVERSAL.BASEURL + "admin/api/product/view_product", {
      method: "POST",
      headers: {
      ...
      .then((responseJson) => {
        if (responseJson.status) {
          setPagination({
            ...pagination,
            relatedProducts: responseJson.result,
      ...
      renderCell: (params) => (
        <StatusMode
          active={
            ...
            product.relatedProductIds.find((item) => item === params.row._id)
              ? true
              : false
          }
        />
  ...
  return (
    <Drawer
      anchor={"right"}
      open={product.editRelatedProduct}
      sx={{
        "& .MuiDrawer-paper": {
      ...
      <Grid container justifyContent={"center"}>
          ...
          <Box sx={{ my: 2, mx: 2, display: "flex", alignItems: "center" }}>
            <Button
              ...
              onClick={() =>
                setProduct({
                  ...product,
                  relatedProductIds: pagination.assignUnassignedStore,
                  assignUnassignedStore: [],
                })
              }
            >
        ...
        <Grid item xs={12}>
          <Table
            ...
            rows={pagination.relatedProducts}
